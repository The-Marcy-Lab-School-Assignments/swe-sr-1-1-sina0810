...
### Response
what is a function? The simpleist way to define a function is to say it's a reusable block of code, where you you can use it as many times as you need. Instead rewriting your code and to call it over and over, we can use a function to do that for us. We can also do some mathematical solutins with function where it takes an input and it will give us back an output. 
such as: 1 + 1 as in put and it will give as back the result of 2 as an output. 

You can think of function as a smoothie blender let's say you want to make a smoothie at home. You need fruits, other ingredents, and a blender to blend everything together. This is input, same us our function we give our function a task to do for example to calculate 1 + 1. 
Back to our smoothie, after we blend everything together, we get a smoothie. I can use the blender as many times I want to make a smoothie without remaking a machine or get anther machine to get another smoothie. This is the same thing for our function the output we get form 1 + 1 is equals to 2, and I can put different input to find solution to different numbers without making a new function we just reusing it. 

Here is an exmple of arrow function: 
